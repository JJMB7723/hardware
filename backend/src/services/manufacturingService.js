...
class ManufacturingService {
  async getBatches(sector = null, status = null) {
    const where = {};
  ...
  async getComponents(type = null, status = null) {
    const where = {};
  ...
  async produceBatch(batchId, data) {
  ...
  async validateBatch(batchId, data) {
  ...
  async reworkComponent(componentId, data) {
